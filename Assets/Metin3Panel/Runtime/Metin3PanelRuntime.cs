...
namespace Metin3Dev.Panel
{
    ...
    [Serializable] public sealed class Metin3WorldPlacementData { public int id; public int map_id; public string map_code; public string target_kind; public int target_vnum; public float x; public float y; public float z; public float direction; public float radius; public float spread_x; public float spread_y; public float spawn_percent = 100f; public int respawn_seconds; public int count; public string source_key; }
