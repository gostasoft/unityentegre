...
namespace Metin3Dev.Panel
{
    ...
    [Serializable] public sealed class Metin3EntityData { public int id; public int vnum; public string name; public string type; public string rank; public int level; public int hp; public int exp; public int min_damage; public int max_damage; public int defense; public int attack_speed; public int move_speed; }
